...
espBox.PointA = Vector2.new(rootPos.X - 30, rootPos.Y + 45)
espBox.PointB = Vector2.new(rootPos.X + 30, rootPos.Y + 45)
espBox.PointC = Vector2.new(headPos.X + 30, headPos.Y)
espBox.PointD = Vector2.new(headPos.X - 30, headPos.Y)
espBox.Visible = true
else
